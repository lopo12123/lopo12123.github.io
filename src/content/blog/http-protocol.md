...
![Request multiplexing](/medias/http-protocol/request_multiplexing.png)

### Header Compression

![Header compression](/medias/http-protocol/hpack.png)

### Binary Protocol

![Binary protocol](/medias/http-protocol/binary_protocol.png)
...
![Http/1.1](/medias/http-protocol/waterfall_1.png)
...
![Http/2](/medias/http-protocol/waterfall_2.png)

- Http/2 with Server Push: 102 requests, 3.17s load time

We can see how requests are made through 1 batch (1 TCP connection).

![Http/2 with Server Push](/medias/http-protocol/waterfall_3.png)

- Animation demonstration

![Animation demonstration](/medias/http-protocol/compare.gif)
